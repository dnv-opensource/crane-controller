...
from crane_controller.envs.controlled_crane_pendulum import AntiPendulumEnv, AntiPendulumConfig
...
if __name__ == "__main__":
    ...
    # conf0 = update_conf(conf1, {'start_speed':0.0,'file':MODELS / "q_pendulum.json",'reward_limit':1000.0}) # start a pendulum
